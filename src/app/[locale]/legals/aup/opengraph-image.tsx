...
export const alt = 'Beswib Acceptable Use Policy - Platform Usage Guidelines'
...
export default async function Image({ params }: { params: Promise<LocaleParams> }) {
	...
	try {
		...
		return new ImageResponse(
			<OGImage title={t.aup.titleOG} secondary={t.aup.descriptionOG} host={host} protocol={protocol} size={size} />,
			{
				...size,
				fonts: [
					{
