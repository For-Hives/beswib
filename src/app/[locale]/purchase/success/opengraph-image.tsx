...
export const alt = 'Beswib Purchase Success Open Graph Image'
...
export default async function Image({ params }: { params: Promise<LocaleParams> }) {
	...
	try {
		...
		return new ImageResponse(
			<OGImage title={t.success.title} secondary={t.success.thanks} host={host} protocol={protocol} size={size} />,
			{
				...size,
				fonts: [
					{
