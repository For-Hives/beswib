...
export const alt = 'Beswib FAQ - Everything You Need to Know'
...
export default async function Image({ params }: { params: Promise<LocaleParams> }) {
	...
	try {
		...
		return new ImageResponse(
			<OGImage title={t.faq.titleOG} secondary={t.faq.descriptionOG} host={host} protocol={protocol} size={size} />,
			{
				...size,
				fonts: [
					{
