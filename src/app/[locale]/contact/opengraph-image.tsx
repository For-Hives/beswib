...
export default async function Image({ params }: { params: Promise<LocaleParams> }) {
	...
	const ogTitle = t.contact?.titleOG ?? tEn.contact?.titleOG ?? 'Beswib'
	const ogSecondary = t.contact?.descriptionOG ?? tEn.contact?.descriptionOG ?? 'Achetez et vendez vos dossards'
