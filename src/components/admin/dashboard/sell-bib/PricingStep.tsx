...
export default function PricingStep({ onChange, locale, formData, errors }: Readonly<PricingStepProps>) {
	...
	// Parse the selling price for fee calculations
	const sellingPriceAmount = parseFloat(formData.sellingPrice) || 0
		...
		<div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
			...
			<div className="lg:col-span-2">
				<div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
					...
					{/* Right Column - Fee Display */}
					<div className="lg:pl-4">
						<FeeDisplay amount={sellingPriceAmount} locale={locale} />
					</div>
				</div>
			</div>
		</div>
