		...
		<Html>
			...
			>
				<Body className="bg-background font-sans">
					<Preview>🚨 Nouvelle vente sur Beswib - {formatPrice(bibPrice)} - {eventName}</Preview>
					<Container className="mx-auto max-w-[600px] px-4 py-8">
						...
						<Section className="bg-card border-border rounded-lg border px-8 py-6 shadow-sm">
							...
							<Section className="bg-success-foreground border-success/20 mb-6 rounded-lg border-2 p-6">
								...
								<Row className="mb-3">
									<Column style={{ width: '60%' }}>
										<Text className="text-muted-foreground text-sm font-medium">Commission Beswib ({conversionRate}%):</Text>
									</Column>
									<Column align="right" style={{ width: '40%' }}>
							...
							<Section className="bg-muted border-border mb-6 rounded-lg border p-6">
								...
								<Section className="grid grid-cols-1 gap-3">
									...
									<Row className="mb-2">
										...
										<Column style={{ width: '70%' }}>
											<Text className="text-foreground text-sm">{bibCategory} • {eventDistance}</Text>
										</Column>
									</Row>
									...
									<Row className="mb-2">
										...
										<Column style={{ width: '70%' }}>
											<Text className="text-foreground text-sm">{eventDate} • {eventLocation}</Text>
										</Column>
									</Row>
								</Section>
							</Section>
							...
							<Section className="bg-muted border-border mb-6 rounded-lg border p-6">
								...
								<Section className="mb-4">
									<Text className="text-muted-foreground text-sm font-medium mb-1">🏪 VENDEUR</Text>
								...
								<Section>
									<Text className="text-muted-foreground text-sm font-medium mb-1">🏃‍♂️ ACHETEUR</Text>
								...
								<Section className="space-y-2">
									<Row>
										...
										<Column style={{ width: '65%' }}>
											<Text className="text-foreground text-xs font-mono">{orderId}</Text>
										</Column>
									</Row>
									...
									<Row>
										...
										<Column style={{ width: '65%' }}>
											<Text className="text-foreground text-xs font-mono">{transactionId}</Text>
										</Column>
									</Row>
									...
									<Row>
										...
										<Column style={{ width: '65%' }}>
											<Text className="text-foreground text-xs font-mono">{paypalCaptureId}</Text>
										</Column>
									</Row>
								</Section>
							</Section>
