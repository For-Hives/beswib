...
// 					<mesh geometry={(nodes.card as { geometry?: THREE.BufferGeometry } | undefined)?.geometry}>
...
// 					{((nodes as Record<string, any>).clip as { geometry?: THREE.BufferGeometry } | undefined)?.geometry != null && (
// 						<mesh geometry={((nodes as Record<string, any>).clip as { geometry?: THREE.BufferGeometry }).geometry}>
// 						<meshStandardMaterial color="#404040" metalness={1} roughness={0.3} />
// 					</mesh>
// 				)}

// 				{/* Clamp - real geometry from GLB model */}
// 					{((nodes as Record<string, any>).clamp as { geometry?: THREE.BufferGeometry } | undefined)?.geometry != null && (
// 						<mesh geometry={((nodes as Record<string, any>).clamp as { geometry?: THREE.BufferGeometry }).geometry}>
