...
export function Illustration(props: Readonly<React.ComponentPropsWithoutRef<'svg'>>) {
	return (
		<svg
...
export function NotFound({
	...
	return (
		<div className="relative z-[1] pt-52 text-center">
			<h1 className="text-primary mt-4 text-5xl font-semibold tracking-tight text-balance sm:text-7xl">{title}</h1>
			<p className="text-muted-foreground mt-6 text-lg font-medium text-pretty sm:text-xl/8">{description}</p>
