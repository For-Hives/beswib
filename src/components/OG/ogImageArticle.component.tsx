...
// Props type definition for the OGImageArticle component
type OGImageArticleProps = {
...
export default function OGImageArticle({
	title,
	size,
	secondary,
	article,
	...
	const titleMain = String(title ?? 'Discover our **latest articles** and **running insights**')
	const secondaryDesc = String(secondary ?? 'Expert tips, **trends**, and stories from the world of **running**')
		...
		>
			...
			>
				...
				>
					...
					>
						<p style={{ margin: 0, fontSize: 16, fontFamily: 'Geist' }}>beswib.com/blog</p>
						<div
							style={{
								gap: '16px',
								flexDirection: 'row',
